...
################################################################
# This is a generated script based on design: SwordFSM
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Net [get_bd_pins S0/q] [get_bd_pins xup_and2_0/a] [get_bd_pins xup_and2_1/a] [get_bd_pins xup_inv_1/a]
  connect_bd_net -net S1_q [get_bd_pins S1/q] [get_bd_pins xup_and2_2/a] [get_bd_pins xup_or2_0/b]
  connect_bd_net -net SW_1 [get_bd_ports SW] [get_bd_pins xup_and2_1/b] [get_bd_pins xup_inv_0/a]
  connect_bd_net -net clk_0_1 [get_bd_ports clock] [get_bd_pins S0/clk] [get_bd_pins S1/clk]
  connect_bd_net -net reset_0_1 [get_bd_ports reset] [get_bd_pins S0/reset] [get_bd_pins S1/reset]
  connect_bd_net -net xup_and2_0_y [get_bd_pins S0/d] [get_bd_pins xup_and2_0/y]
  connect_bd_net -net xup_and2_1_y [get_bd_pins xup_and2_1/y] [get_bd_pins xup_or2_0/a]
  connect_bd_net -net xup_and2_2_y [get_bd_ports V] [get_bd_pins xup_and2_2/y]
  connect_bd_net -net xup_inv_0_y [get_bd_pins xup_and2_0/b] [get_bd_pins xup_inv_0/y]
  connect_bd_net -net xup_inv_1_y [get_bd_pins xup_and2_2/b] [get_bd_pins xup_inv_1/y]
  connect_bd_net -net xup_or2_0_y [get_bd_pins S1/d] [get_bd_pins xup_or2_0/y]
