...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/SwordFSM.protoinst" -protoinst "protoinst_files/LocationFSM.protoinst" -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/LocationFSM.protoinst" -protoinst "protoinst_files/SwordFSM.protoinst" -log simulate.log
}
