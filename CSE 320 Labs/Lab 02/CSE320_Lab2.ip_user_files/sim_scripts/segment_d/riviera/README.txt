...
#
# Generated by export_simulation on Fri Feb 14 02:33:40 -0700 2020
#
################################################################################
...
'-reset_run' switch to the './segment_d.sh' script.

./segment_d.sh -reset_run
...
./segment_d.sh -noclean_files

For more information on the script, please type './segment_d.sh -help'.
