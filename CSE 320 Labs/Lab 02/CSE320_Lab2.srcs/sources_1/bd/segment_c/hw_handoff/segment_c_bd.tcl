...
################################################################
# This is a generated script based on design: segment_c
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net a_0_1 [get_bd_ports D1] [get_bd_pins xup_and3_0/b] [get_bd_pins xup_inv_1/a]
  connect_bd_net -net a_1_1 [get_bd_ports D0] [get_bd_pins xup_inv_0/a]
  ...
  connect_bd_net -net xup_and3_0_y [get_bd_ports S] [get_bd_pins xup_and3_0/y]
