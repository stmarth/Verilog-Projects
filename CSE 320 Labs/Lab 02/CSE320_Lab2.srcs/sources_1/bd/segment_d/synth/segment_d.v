...
module segment_d
  ...
  assign a_2_1 = D3;
  assign a_3_1 = D2;
  segment_d_xup_and3_0_0 xup_and3_0
       (.a(xup_inv_0_y),
        .b(xup_inv_1_y),
        .c(a_3_1),
        .y(xup_and3_0_y));
  segment_d_xup_and3_0_1 xup_and3_1
       (.a(a_1_1),
        .b(xup_inv_1_y),
        .c(xup_inv_2_y),
        .y(xup_and3_1_y));
  segment_d_xup_and3_0_2 xup_and3_2
       (.a(a_1_1),
        .b(a_0_1),
        .c(a_3_1),
        .y(xup_and3_2_y));
  ...
  segment_d_xup_inv_0_3 xup_inv_3
       (.a(a_2_1));
  segment_d_xup_or3_0_0 xup_or3_0
       (.a(xup_and3_0_y),
        .b(xup_and3_1_y),
        .c(xup_and3_2_y),
        .y(xup_or3_0_y));
