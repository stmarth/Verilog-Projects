...
################################################################
# This is a generated script based on design: segment_g
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net a_0_1 [get_bd_ports D1] [get_bd_pins xup_and3_1/b] [get_bd_pins xup_inv_1/a]
  connect_bd_net -net a_1_1 [get_bd_ports D0] [get_bd_pins xup_and3_1/a] [get_bd_pins xup_inv_0/a]
  connect_bd_net -net a_2_1 [get_bd_ports D2] [get_bd_pins xup_and3_1/c] [get_bd_pins xup_inv_2/a]
  ...
  connect_bd_net -net xup_inv_1_y [get_bd_pins xup_and3_0/a] [get_bd_pins xup_inv_1/y]
  connect_bd_net -net xup_inv_2_y [get_bd_pins xup_and3_0/b] [get_bd_pins xup_inv_2/y]
  connect_bd_net -net xup_inv_3_y [get_bd_pins xup_and3_0/c] [get_bd_pins xup_inv_3/y]
  connect_bd_net -net xup_or2_0_y [get_bd_ports S] [get_bd_pins xup_or2_0/y]
