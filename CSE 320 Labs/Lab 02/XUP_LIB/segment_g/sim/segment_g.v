...
(* CORE_GENERATION_INFO = "segment_g,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=segment_g,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "segment_g.hwdef" *) 
module segment_g
   (D0,
    D1,
    D2,
  ...
  segment_g_xup_inv_0_2 xup_inv_2
       (.a(a_2_1),
        .y(xup_inv_2_y));
  segment_g_xup_inv_0_3 xup_inv_3
       (.a(a_3_1),
        .y(xup_inv_3_y));
