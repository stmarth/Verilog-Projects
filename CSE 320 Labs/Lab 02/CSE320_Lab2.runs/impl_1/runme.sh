...
HD_PWD='C:/Users/stefa/iCloudDrive/ASU/Spring 2020/CSE_320/Labs_New/CSE320_Lab2/CSE320_Lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log display_decoder_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source display_decoder_wrapper.tcl -notrace
