...
HD_PWD='C:/Users/stefa/iCloudDrive/ASU/Spring 2020/CSE_320/Labs_New/CSE320_Lab2/CSE320_Lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log display_decoder_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source display_decoder_wrapper.tcl
