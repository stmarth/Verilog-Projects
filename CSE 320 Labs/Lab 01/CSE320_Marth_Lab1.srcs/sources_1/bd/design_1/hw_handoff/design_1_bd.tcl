...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Net [get_bd_ports Cin] [get_bd_pins xup_and2_0/a] [get_bd_pins xup_xor2_1/b]
  connect_bd_net -net a_0_1 [get_bd_ports a] [get_bd_pins xup_and2_1/b] [get_bd_pins xup_xor2_0/a]
  connect_bd_net -net b_0_1 [get_bd_ports b] [get_bd_pins xup_and2_1/a] [get_bd_pins xup_xor2_0/b]
  ...
  connect_bd_net -net xup_xor2_0_y [get_bd_pins xup_and2_0/b] [get_bd_pins xup_xor2_0/y] [get_bd_pins xup_xor2_1/a]
